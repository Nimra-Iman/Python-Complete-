...
# is file s name=main hta kr dekho or phir name_equal_main.py m import kro is module ko (yani name2_equal_main)
# just import kro and you will see k harry vali output show ho gi, although hm n harry ko call kia hi nhi
