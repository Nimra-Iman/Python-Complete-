...
# following will give "None" because .sort() returns "None", but if you want to 
# make a new list which will be the sorted version of the previous, use sorted() method
fehre_new = fehri.sort()
print(fehre_new)  

fehre_neww = sorted(fehri)
print(fehre_neww)
...
l=[4,5,6,7,8]
m=[1000,344,22222]
l.extend(m) #is ka matlab y h k "m" ko utha kr "l" k end pr daal do, is m actually 
# string conctinate nhi ho rhi bal k hm "l" ko edit kr rhy hn, jab k concatinate m ek
#  new string m 2 strings add hoti h yani concatinate hoti h  
print(l)
