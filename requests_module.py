...
print( soup.prettify()) #jo html code mila us ko beautify krny k liye y use kia

for headings in soup.find_all("h2"): #yani m chahti hu k jo saara code mila us m s sirf
    # <h2> heading k ander likha hua text show kro(yani ap scraping kr rhy o or jab bhi 
